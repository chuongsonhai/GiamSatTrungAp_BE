...
{
    [RoutePrefix("api/BaoCaoTongHopctgsControlle")]
    public class BaoCaoTongHopctgsController : ApiController
    {
        private ILog log = LogManager.GetLogger(typeof(BaoCaoTongHopctgsController));
        //[JwtAuthentication]
        [HttpPost]
        [Route("baocaothctgs")]
