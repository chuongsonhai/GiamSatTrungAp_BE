        ...
        public IHttpActionResult TraHoSo(CancelModel model)
        {
            ...
            try
            {
                ...
                if (item.TrangThai == TrangThaiCongVan.Huy)
                {
                    ...
                    canhbao.NOIDUNG = "Loại cảnh báo 9 - lần " + canhbao.LOAI_SOLANGUI + " <br>KH: " + item.TenKhachHang + ", SĐT: " + item.DienThoai + ", ĐC: " + item.DiaChiDungDien + ", MaYC: " + canhbao.MA_YC + ", ngày tiếp nhận: " + item.NgayLap + " ĐV: " + item.MaDViQLy + " Yêu cầu lập thỏa thuận đấu nối bị từ chối tiếp nhận, đơn vị hãy tiếp nhận yêu cầu lập thỏa thuận đấu nối trên hệ thống Ứng dụng cấp điện mới trực tuyến và giám sát các chỉ số tiếp cận điện năng.";
