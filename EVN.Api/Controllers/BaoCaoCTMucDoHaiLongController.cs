...
{
    [RoutePrefix("api/BaoCaoCTMucDoHaiLongController")]
    public class BaoCaoCTMucDoHaiLongController : ApiController
    {
        private ILog log = LogManager.GetLogger(typeof(BaoCaoCTMucDoHaiLongController));
        [JwtAuthentication]
        [HttpPost]
        [Route("BaoCaoCTMucDoHaiLong")]
        ...
        [JwtAuthentication]
        [HttpPost]
        [Route("exportBaoCaoCTMucDoHaiLongController")]
