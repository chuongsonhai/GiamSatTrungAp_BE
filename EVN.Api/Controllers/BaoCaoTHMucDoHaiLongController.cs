...
{
    [RoutePrefix("api/BaoCaoTHMucDoHaiLongController")]
    public class BaoCaoTHMucDoHaiLongController : ApiController
    {
        private ILog log = LogManager.GetLogger(typeof(BaoCaoTHMucDoHaiLongController));
       // [JwtAuthentication]
        [HttpPost]
        [Route("BaoCaoTHMucDoHaiLong")]
      ...
      //  [JwtAuthentication]
        [HttpPost]
        [Route("exportBaoCaoTHMucDoHaiLong")]
