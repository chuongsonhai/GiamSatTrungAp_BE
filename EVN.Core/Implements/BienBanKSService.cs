    ...
    public class BienBanKSService : FX.Data.BaseService<BienBanKS, int>, IBienBanKSService
    {
        ...
        public bool HuyHoSo(BienBanKS bienban, KetQuaKS ketqua)
        {
            try
            {
                ...
                canhbao.NOIDUNG = "Loại cảnh báo 11 - lần " + canhbao.LOAI_SOLANGUI + " <br> KH: " + yeucau.TenKhachHang + ", SĐT: " + yeucau.DienThoai + ", ĐC: " + yeucau.DiaChiCoQuan + ", MaYC: " + canhbao.MA_YC + ", ngày tiếp nhận: " + yeucau.NgayYeuCau + " ĐV: " + yeucau.MaDViQLy + " Khách hàng từ chối ký thỏa thuận đấu nối với lý do " + ketqua.NDUNG_XLY + ", đơn vị kiểm tra lý do cập nhật trên hệ thống với thực tế tại hồ sơ và liên hệ với khách hàng để xử lý đúng qui định";
