...
namespace EVN.Core.Implements
{
    public class LoaiCanhBaoService : FX.Data.BaseService<DanhMucLoaiCanhBao, int>, ILoaiCanhBaoService
    {
        ...
        public IList<DanhMucLoaiCanhBao> GetbyFilter(string TenLoaiCanhBao, int pageindex, int pagesize, out int total)
        {
            var query = Query.Where(p => p.TenLoaiCanhBao == TenLoaiCanhBao);
            total = query.Count();
