...
{
    public class GiamSatCongVanCanhbaoidService : FX.Data.BaseService<GiamSatCongVanCanhbaoid, int>, IGiamSatCongVanCanhbaoidService
    {
        private ILog log = LogManager.GetLogger(typeof(GiamSatCongVanCanhbaoidService));
        public GiamSatCongVanCanhbaoidService(string sessionFactoryConfigPath, string connectionString = null) : base(sessionFactoryConfigPath, connectionString)
        {
        }

        public GiamSatCongVanCanhbaoid GetbyMaYCau(string maYCau)
        {
            return Get(p => p.MaYeuCau == maYCau);
        }

        //public IList<GiamSatCongVanCanhbaoid> GetbyFilter(string maDViQLy, string keyword, string khachhang, int status, DateTime fromdate, DateTime todate, int pageindex, int pagesize, out int total)
        //{
        //    var query = Query;
        ...
        //public IList<GiamSatCongVanCanhbaoid> GetThongKe(string maDViQLy, string keyword, DateTime fromdate, DateTime todate, int pageindex, int pagesize, out int total)
        //{
        //    var query = Query;
        //    if (fromdate != DateTime.MinValue)
        //        query = query.Where(p => p.NgayYeuCau >= fromdate && p.NgayYeuCau < todate.AddDays(1));
        ...
        //public IList<GiamSatCongVanCanhbaoid> GetThongKeExport(string maDViQLy, string keyword, DateTime fromdate, DateTime todate)
        //{
        //    var query = Query;
        //    if (fromdate != DateTime.MinValue)
        //        query = query.Where(p => p.NgayYeuCau >= fromdate && p.NgayYeuCau < todate.AddDays(1));
        ...
        //    return query.ToList();
        //}
        //public IList<GiamSatCongVanCanhbaoid> GetList(string maDViQLy, DateTime fromdate, DateTime todate, out int total)
        //{
        //    var query = Query;
        //    if (fromdate != DateTime.MinValue)
        //        query = query.Where(p => p.NgayYeuCau >= fromdate && p.NgayYeuCau < todate.AddDays(1));
        ...
        //    return query.ToList();
        //}
        //public bool CreateNew(GiamSatCongVanCanhbaoid congvan, out string message)
        //{
        //    message = "";
        ...
        //public bool YeuCauKhaoSat(GiamSatCongVanCanhbaoid congvan, string maCViec, string bPhanNhan, string nVienNhan, DateTime ngayHen, string noiDung, out string message)
        //{
        //    message = "";
        //    try
        //    {
        ...
        //            if (yeucau == null)
        //            {
        //                yeucau = new GiamSatCongVanCanhbaoid();
        //                yeucau.MaCViec = "YCM";
        ...
        //public GiamSatCongVanCanhbaoid SyncData(string maYCau)
        //{
        //    try
        //    {
        ...
        //public GiamSatCongVanCanhbaoid DongBo(GiamSatCongVanCanhbaoid yeucau)
        //{
        //    try
        //    {
        ...
        //public bool Cancel(GiamSatCongVanCanhbaoid yeucau)
        //{
        //    try
        //    {
        //        IThongBaoService service = IoC.Resolve<IThongBaoService>();
        ...
        /// </summary>
        public bool CancelYeuCauKhaoSat(GiamSatCongVanCanhbaoid congvan)
        {
            try
            {
                IGiamSatCongVanCanhbaoidService congvansrv = IoC.Resolve<IGiamSatCongVanCanhbaoidService>();
