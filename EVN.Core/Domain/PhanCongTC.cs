...
namespace EVN.Core.Domain
{
    public class PhanCongTC
    {
        ...
        public virtual DateTime NGAY_HEN { get; set; }
        public virtual DateTime NGAY_BDAU { get; set; }
        ...
        public virtual int LOAI { get; set; } = 0; //0: Phân công kiểm tra, 1: Phân công thi công
    }
}
